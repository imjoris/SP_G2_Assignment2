...
\input{0-predocument/glossary.tex}
\makeglossary
...
% Joris: Has to be called after the title page, because that page messes up the float styles.
\let\newfloat\relax
...
%Conditionally insert List of Tables (if not empty)
\conditionalLoT
