...
\begin{longtable}{p{0.2\textwidth} p{0.7\textwidth} p{0.1\textwidth}}
	...
	Fakambi         & Meetings, process feedback, improvements &12 \\ \midrule
	Joris 			& Process feedback and general reviewing, restructure, improvements on logical view, evaluation and recommendation & 20 \\ \midrule
	Menninga        & Meetings, processing feedback, improvements to patterns/evaluation, intro recommendations& 13  \\ \bottomrule
\end{longtable}
