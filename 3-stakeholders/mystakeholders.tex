...
\item[Security] The Docker developers care about the security of the product they are working on. Their changes will not be accepted by the community if they can introduce security flaws.  % somebody has to care about it
